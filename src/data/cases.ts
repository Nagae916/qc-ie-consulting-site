...
export const caseStudies: CaseStudy[] = [
  {
    ...
    subtitle: "製造実績がない新規製品における暫定的な判定基準と見直しプロセスの設計",
  ...
  },
  {
    ...
    subtitle: "外部試験所を活用した品質評価と試験結果の妥当性確認",
    question: "外部機関から得た数値を、品質判断へ使えるデータにするには何を確認するか。",
    summary:
      "試験目的、試料の代表性、測定条件、不確かさ、比較対象を整理し、外部試験所の結果を承認可能な品質情報へ変換するケースです。",
    themes: ["quality", "data", "improvement"],
    contentType: "case-study",
    difficulty: "advanced",
